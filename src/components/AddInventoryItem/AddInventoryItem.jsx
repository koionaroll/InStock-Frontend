        ...
        <section className="addInventory">
          <div className="addInventory__header">
            <NavLink
              ...
              className="addInventory__back__btn"
            >
            ...
            <div className="addInventory__wrapper">
              <div className="addInventory__section1">
                <div className="addInventory__details1">
                  ...
                  <div className="addInventory__form">
                    <label
                      className="addInventory__subtitle"
                      htmlFor="itemName"
                    >
                      Item Name
                    </label>
                    ...
                    >
                      <img
                        className={`${
                          itemNameError ? "addInventory__error--icon" : ""
                        }`}
                        src={errorIcon}
                        alt="error"
                      />
                      <p
                        className={`${
                          itemNameError ? "addInventory__error--text" : ""
                        }`}
                      >
                        {" "}
                  ...
                  <div className="addInventory__form">
                    ...
                    >
                      <img
                        className={`${
                          descriptionError ? "addInventory__error--icon" : ""
                        }`}
                        src={errorIcon}
                        alt="error"
                      />
                      <p
                        className={`${
                          descriptionError ? "addInventory__error--text" : ""
                        }`}
                      >
                        {" "}
                        This field is required{" "}
              ...
              <div className="addInventory__section2">
                <div className="addInventory__details2">
                  ...
                  <div className="addInventory__form">
                    <p className="addInventory__subtitle" htmlFor="status">
                      Status
                    </p>
                  ...
                  >
                    ...
                    >
                      <img
                        className={`${
                          quantityError ? "addInventory__error--icon" : ""
                        }`}
                        src={errorIcon}
                        alt="error"
                      />
                      <p
                        className={`${
                          quantityError ? "addInventory__error--text" : ""
                        }`}
                      >
                        {" "}
                        This field is required{" "}
