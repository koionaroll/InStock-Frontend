...
const WarehousePageForm = ({ apiUrl, formType, placeHolderInfo }) => {
  ...
  const [address, setAddress] = useState(
    formType === "Edit" ? placeHolderInfo.address : ""
  );
  const [city, setCity] = useState(
    formType === "Edit" ? placeHolderInfo.city : ""
  );
  const [country, setCountry] = useState(
    formType === "Edit" ? placeHolderInfo.country : ""
  );
  const [contactName, setContactName] = useState(
    formType === "Edit" ? placeHolderInfo.contact_name : ""
  );
  const [contactPosition, setContactPosition] = useState(
    formType === "Edit" ? placeHolderInfo.contact_position : ""
  );
      ...
      <section className="form">
          ...
          <div className="form__details-left">
            ...
            <div className="form__input-container">
              ...
              <input
                ...
                className={`form__input ${
                  warehouseNameError ? "form__input--error" : ""
                }`}
                placeholder={placeHolderInfo.warehouse_name}
              />
              {/* `form__input form__input${textFieldError}` */}
              <div
                className={`${
                  warehouseNameError ? "form__error" : "form__valid"
                }`}
              >
                <img
                  className={`${warehouseNameError ? "form__error-icon" : ""}`}
                  src={errorIcon}
                  alt="error"
                />
                <p
                  className={`${warehouseNameError ? "form__error-text" : ""}`}
                >
                  {" "}
            ...
            <div className="form__input-container">
              ...
              <input
                ...
                id="address"
                className={`form__input ${
                  addressError ? "form__input--error" : ""
                }`}
                placeholder={placeHolderInfo.address}
              />

              <div
                className={`${addressError ? "form__error" : "form__valid"}`}
              >
                <img
                  className={`${addressError ? "form__error-icon" : ""}`}
                  src={errorIcon}
                  alt="error"
                />
                <p className={`${addressError ? "form__error-text" : ""}`}>
                  {" "}
                  This field is required{" "}
                </p>
              </div>
            ...
            <div className="form__input-container">
              ...
              <input
                ...
                id="city"
                className={`form__input ${
                  cityError ? "form__input--error" : ""
                }`}
                placeholder={placeHolderInfo.city}
              />

              <div className={`${cityError ? "form__error" : "form__valid"}`}>
                <img
                  className={`${cityError ? "form__error-icon" : ""}`}
                  src={errorIcon}
                  alt="error"
                />
                <p className={`${cityError ? "form__error-text" : ""}`}>
                  {" "}
                  This field is required{" "}
                </p>
              </div>
            ...
            <div className="form__input-container">
              ...
              <input
                ...
                id="country"
                className={`form__input ${
                  countryError ? "form__input--error" : ""
                }`}
                placeholder={placeHolderInfo.country}
              />

              <div
                className={`${countryError ? "form__error" : "form__valid"}`}
              >
                <img
                  className={`${countryError ? "form__error-icon" : ""}`}
                  src={errorIcon}
                  alt="error"
                />
                <p className={`${countryError ? "form__error-text" : ""}`}>
                  {" "}
                  This field is required{" "}
                </p>
              </div>
          ...
          <div className="form__details-right">
            ...
            <div className="form__input-container">
              ...
              <input
                ...
                placeholder={placeHolderInfo.contact_name}
              />

              <div className={`${nameError ? "form__error" : "form__valid"}`}>
                <img
                  className={`${nameError ? "form__error-icon" : ""}`}
                  src={errorIcon}
                  alt="error"
                />
                <p className={`${nameError ? "form__error-text" : ""}`}>
                  {" "}
                  This field is required{" "}
                </p>
              </div>
            ...
            <div className="form__input-container">
              ...
              <input
                ...
                id="contact_position"
                className={`form__input ${
                  positionError ? "form__input--error" : ""
                }`}
                placeholder={placeHolderInfo.contact_position}
              />
              <div
                className={`${positionError ? "form__error" : "form__valid"}`}
              >
                <img
                  className={`${positionError ? "form__error-icon" : ""}`}
                  src={errorIcon}
                  alt="error"
                />
                <p className={`${positionError ? "form__error-text" : ""}`}>
                  {" "}
                  This field is required{" "}
                </p>
              </div>
            ...
            <div className="form__input-container">
              ...
              <input
                ...
                placeholder={placeHolderInfo.contact_phone}
              />

              <div className={`${phoneError ? "form__error" : "form__valid"}`}>
                <img
                  className={`${phoneError ? "form__error-icon" : ""}`}
                  src={errorIcon}
                  alt="error"
                />
                <p className={`${phoneError ? "form__error-text" : ""}`}>
                  {" "}
                  This field is required{" "}
                </p>
              </div>
            ...
            <div className="form__input-container">
              ...
              <input
                ...
                placeholder={placeHolderInfo.contact_email}
              />
              <div className={`${emailError ? "form__error" : "form__valid"}`}>
                <img
                  className={`${emailError ? "form__error-icon" : ""}`}
                  src={errorIcon}
                  alt="error"
                />
                <p className={`${emailError ? "form__error-text" : ""}`}>
                  {" "}
                  This field is required{" "}
                </p>
              </div>
        ...
        <div className="form__buttons">
          ...
          <button
            ...
            type="submit"
            to="/warehouse"
            className={`${formType === "Edit" ? "form__edit" : "form__add"}`}
          >
